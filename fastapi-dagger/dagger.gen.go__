...
func (r *Client) LoadGithubCommentFromID(id GithubCommentID) *GithubComment {
	q := r.q.Select("loadGithubCommentFromID")
	q = q.Arg("id", id)
...
func (r *GithubCi) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "GithubCi":
		...
		case "Handle":
			...
			return nil, (*GithubCi).Handle(&parent, ctx, eventFile)
		default:
	...
	case "":
		return dag.Module().
			WithObject(
				dag.TypeDef().WithObject("GithubCi").
					WithFunction(
						dag.Function("Handle",
